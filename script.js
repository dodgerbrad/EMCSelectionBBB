...
async function loadGoogleSheetData() {
    // Show loader is handled by CSS default, but you can ensure it here
    ...
    try {
        ...
        // Populate your player dropdowns here...
        populatePlayers(data);

    } catch (error) {
        console.error("Error loading data:", error);
        document.querySelector('#loader-overlay p').innerText = "Error loading data. Please refresh.";
    } finally {
